/* Browse Abandonment · GF Cross-Level · Content
   Flow: Browse Abandonment (Flow 04) | Level: GF (R1-R6/V16)
   FLOW1_SHARED aligned to primitives (Signoff uses line1/ps)
*/

window.BROWSE = {
  // ═════════════════════════════════════════════════════
  // EMAIL 1 — The Signal (30 min)
  // Education-only. NO product. NO offer.
  // Sections: Opener+Anchors → Validation → Mechanism → Testimonials → Permission+SoftCTA
  // ═════════════════════════════════════════════════════
  e1: {
    ...
    opener: "Whether your child is 3 or 10, talks about the potty but won't use it, or has never shown a single sign of feeling wet — if the \"I need to go\" signal doesn't arrive when it should, every method that depends on it was built on the wrong foundation.",
    ...
    bridgeLine: "If even one of those sounds like your morning, keep reading.",

    validationLabel: "The methods you've tried",
    ...
    validationReframe: "That's not a parenting gap. That's a signal-timing gap.",

    mechanismLabel: "It's called interoception.",
    ...
    testimonialsLabel: "Three families. Three different kids. One common missing piece.",
    testimonials: [
    ...
    ctaIntro: "If any of this sounds like your child, the next step isn't buying anything. The next step is understanding why the signal isn't arriving, and what \"signal arrival\" actually looks like for a nervous system that processes differently.",
    ctaButton: "Keep reading →",
    ctaFine: "60 days to try. By your judgment. No pressure either way.",
  },

  // ═════════════════════════════════════════════════════
  // EMAIL 2 — Three Parents (24h)
  // Sections: Opener→3 Testimonials→Mechanism→CTA→Migration anchors
  // ═════════════════════════════════════════════════════
  e2: {
    ...
    testimonials: [
      { title: "\"Almost trained\" but not quite", name: "Sarah", child: "mom of a 3-year-old",
      ...
      { title: "Sensory, BCBA, still stuck", name: "Lisa", child: "mom of a 5-year-old",
      ...
      { title: "Years of nothing, then something", name: "Maria", child: "mom of a 9-year-old",
  ...
  // ═════════════════════════════════════════════════════
  // EMAIL 3 — 60 Days (72h)
  // Sections: Hook→Anchors→Mechanism+Mahler→Mini-wins→Product→Guarantee→FilledCTA
  // ═════════════════════════════════════════════════════
  e3: {
    ...
    anchorLabel: "You've probably experienced some version of this:",
    anchors: [
    ...
    mechanismLabel: "Here's what we know now that we didn't know five years ago:",
    ...
    miniWinsLabel: "The parents who've tried it describe success in small, real moments:",
    miniWins: [
