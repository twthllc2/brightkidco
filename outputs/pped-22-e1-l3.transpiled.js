(() => {
  ...
  var PPEdExtE1L3 = function() {
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        { style: { background: BG_HERO, padding: "48px 32px 16px" } },
        React.createElement(
          "div",
        ...
        React.createElement(
          "h1",
          { style: { fontFamily: F.display, fontSize: 24, lineHeight: 1.4, color: B.ink, margin: "0 0 20px", fontWeight: 400, textAlign: "center" } },
          c.h1a,
          React.createElement("br"),
      ...
      React.createElement(
        "div",
        { style: { margin: "0 14px 20px", borderRadius: 20, overflow: "hidden", border: "2px solid " + B.ink, boxShadow: "6px 6px 0 " + B.ink } },
        React.createElement("img", { src: IMG_HERO, alt: "BrightKidCo Training Pant", style: { width: "100%", display: "block" } })
      ),
      /* Hook body */
      React.createElement(
        "div",
        { style: { background: BG_HERO, padding: "0 32px 40px" } },
      ...
      React.createElement(
        "div",
        { style: { background: BG_LETTER, padding: "40px 32px 20px" } },
      ...
      React.createElement(
        "div",
        { style: { background: BG_LETTER, padding: "20px 32px 40px" } },
        React.createElement(
          "div",
          { style: { background: "#FFFFFF", borderRadius: 12, padding: "20px 16px", borderLeft: "3px solid " + B.accent } },
      ...
      React.createElement(
        "div",
        { style: { background: BG_RESEARCH, padding: "40px 32px 20px" } },
      ...
      React.createElement(
        "div",
        { style: { background: BG_RESEARCH, padding: "0 24px 14px" } },
        React.createElement(
          "div",
          { style: { background: "#FFFFFF", borderRadius: 12, padding: "16px 16px", marginBottom: 10, borderLeft: "3px solid #2BAEB4" } },
          React.createElement("p", { style: { fontSize: 14, lineHeight: 1.7, color: B.soft, margin: 0 } }, c.mechanismHow)
        ),
        React.createElement(
          "div",
          { style: { background: "#FFFFFF", borderRadius: 12, padding: "16px 16px", marginBottom: 14, borderLeft: "3px solid #FFD866" } },
      ...
      React.createElement(
        "div",
        { style: { background: BG_MECHANISM, padding: "0 14px 20px" } },
        React.createElement(
          "div",
      ...
      React.createElement(
        "div",
        { style: { background: BG_TESTIMONIAL, padding: "40px 32px 20px" } },
      ...
      React.createElement(
        "div",
        { style: { background: BG_TESTIMONIAL, padding: "0 24px 14px" } },
        React.createElement(
          "div",
          { style: { background: "#FFFFFF", borderRadius: 12, padding: "24px 20px", border: "1px solid " + B.accent } },
      ...
      React.createElement(
        "div",
        { style: { background: BG_TESTIMONIAL, padding: "14px 32px 40px" } },
      ...
      React.createElement(
        "div",
        { style: { background: BG_PRODUCT, padding: "40px 32px 20px" } },
      ...
      React.createElement(
        "div",
        { style: { background: BG_GUARANTEE, padding: "40px 32px 32px", textAlign: "center" } },
        React.createElement(Eyebrow, { color: B.sageDeep }, "Our promise"),
        React.createElement(
          "h2",
          { style: { fontFamily: F.display, fontSize: 22, lineHeight: 1.3, color: B.ink, margin: "0 0 16px", fontWeight: 400 } },
      ...
      React.createElement(
        "div",
        { style: { background: BG_GUARANTEE, padding: "0 24px 32px", textAlign: "center" } },
        React.createElement(
          "div",
          { style: { display: "inline-flex", flexDirection: "column", alignItems: "center", width: 140, height: 140, background: "#FFFFFF", borderRadius: "50%", border: "3px solid " + B.ink, boxShadow: "6px 6px 0 " + B.ink, justifyContent: "center" } },
      ...
      React.createElement(
        "div",
        { style: { background: BG_CTA, padding: "36px 32px 24px", textAlign: "center", color: "#FBF7F1" } },
        ...
        React.createElement(
          "div",
          { style: { background: "rgba(255,255,255,0.08)", borderRadius: 10, padding: "14px 16px", margin: "0 0 24px" } },
      ...
      React.createElement(
        "div",
        { style: { background: BG_CTA, padding: "0 32px 44px", textAlign: "center" } },
