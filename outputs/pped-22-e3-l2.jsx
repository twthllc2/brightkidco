/* PP-Extended Education E3 (D36) -- L2 Lisa
   Built from: pped-22-e3-l2.md
   Pattern: welcome-e2-l1 reference
   Images: embedded product photos (mandatory)
*/
...
var PPExtEdE3L2 = function() {
  ...
  return React.createElement(EmailShell, { preheader: c.preheader, bg: BG_HERO },
    ...
    React.createElement(
      ...
      /* Highlight box */
      React.createElement("div", { style: { background: B.teal, borderRadius: 8, padding: 18, textAlign: "center", marginBottom: 12 } },
    ...
    React.createElement(
      ...
      /* Stall note */
      React.createElement("div", { style: { background: "#FFFFFF", borderRadius: 10, padding: 14, marginTop: 16, borderLeft: "3px solid " + B.muted } },
    ...
    React.createElement(
      ...
      /* Bullet 2 */
      React.createElement("div", { style: { display: "flex", gap: 12, alignItems: "flex-start", marginBottom: 0 } },
    ...
    React.createElement(
      ...
      /* Timeline entries */
      React.createElement("div", { style: { borderLeft: "3px solid " + B.teal, paddingLeft: 14, marginBottom: 10 } },
        React.createElement("p", { style: { fontSize: 13, color: B.soft, margin: "0 0 10px", lineHeight: 1.6 } },
        ...
        React.createElement("p", { style: { fontSize: 13, color: B.soft, margin: 0, lineHeight: 1.6 } },
