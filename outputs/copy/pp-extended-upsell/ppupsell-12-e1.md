...
## Offer Table by Purchase Tier

| Current Purchase | Upsell Target | Price | Angle |
|:----------------:|:------------:|:-----:|-------|
| 1 Pair ($34.99) | 3+3 Bundle | $79.99 | "Consistent daily signal — 6 pairs for full rotation. No wash-gaps." |
| 3+3 Bundle ($79.99) | 5+5 Bundle | $119.99 | "Maximum rotation for maximum signal density. 10 pairs." |
| 5+5 Bundle ($119.99) | — (Maintain) | — | "You're set. Watch for the next education email." |

**Level Offer Rules Applied:**
- **L1 (Sarah):** 1pr→3+3 or 3+3→5+5. Pre-K window frame in CTA if applicable.
- **L2 (Lisa):** 1pr→3+3 or 3+3→5+5. BCBA-complement angle. Permission-first.
- **L3 (Maria):** 1pr→3+3 maximum. NEVER 5+5. Dignity-first. "When you're ready."
- **GF:** 1pr→3+3 default. Cross-level offer language with migration anchors.
...
|----------|--------------|--------|
| **Flow** | PP Extended Upsell (Flow 12) | GIULIANO-DEMANDS.md §2.2 |
| **Position** | E1 (first of 3) | S02-A-framework.md §4.12 |
| **Timing** | Day 28 post-purchase | S02-A-framework.md §4.12 |
| **Goal** | Bundle upgrade — introduce extended product line | GIULIANO-DEMANDS.md §2.2 |
| **Type** | Cross-Level (single copy, R1-R6) | 1-full-email-strategy.md §5.1 |
| **Audience** | All existing buyers with any level tag | GIULIANO-DEMANDS.md §2.2 |
| **Phase** | Phase 2 (Month 3-4) | 1-full-email-strategy.md §9.2 |
...
- Testimonials feature real mini-wins: "paused mid-play and looked down", "walked to the bathroom on his own. Once.", "touched his waistband"

## Three-Family Testimonial Pattern — Application ✅

Three distinct parent voices, each representing a different level experience:

| Voice | Child Profile | Win | Level Signal |
|-------|--------------|-----|-------------|
...
|-----------|----------------------|---------------------|----------------------|---------------|
| **Hope Level** 50/50 | 70/30 feels slightly low — but Pre-K not mentioned here, so acceptable | 40/60 — matches her calibrated hope | 20/80 — reads the "maybe nothing visible" permission as respectful | 50/50 — matches GF baseline |
| **Urgency** | None in body — okay at D28 post-purchase; she's already bought | None — correct | ZERO — correct | None — correct |
| **Science Density** | Medium — can follow; mechanism explained simply | Medium-Low — lighter than L2 prefers but acceptable in upsell context | Low — correct for dignity-first | Medium — correct |
...
|--------|--------|--------|
| "Level 1/2/3" | ❌ NOT PRESENT | R1 violation |
| "ASD", "Autism" | ❌ NOT PRESENT | GF Sub-Group B, C sensitivity |
| "Fix", "Cure" | ❌ NOT PRESENT | L3 forbidden |
| "Easy", "Quick" | ❌ NOT PRESENT | Universal forbidden |
| "Don't give up!" | ❌ NOT PRESENT | Patronizing — L2, L3 forbidden |
| "Your child WILL train" | ❌ NOT PRESENT | Over-promise — L3 forbidden |
| "Buy Now", "Shop Today" | ❌ NOT PRESENT | Marketing voice forbidden |
| "Last Chance", "Don't Miss" | ❌ NOT PRESENT | Fake scarcity forbidden |
| "Fully trained" as success | ❌ NOT PRESENT | R6 — defined as mini-wins |
| "Pre-K is coming" | ❌ NOT PRESENT | L2 trigger — Pre-K urgency irrelevant |
| "Save him from diapers" | ❌ NOT PRESENT | Grief sales tool — L3 forbidden |
| "Adult diapers" | ❌ NOT PRESENT | Trauma-sensitivity — L1, L3 |
| "Neurotypical", "Normal kids" | ❌ NOT PRESENT | Comparison forbidden |
| "Money-back guarantee" | ❌ NOT PRESENT | Use "60-Day Guarantee" |
| Exclamation marks in body | ❌ NOT PRESENT | L3 rejects marketing language |

## Offer Compliance by Level

| Level | Offer Path | Compliance | Notes |
|-------|-----------|------------|-------|
| **L1** | 1pr→3+3 OR 3+3→5+5 | ✅ | Urgency OK but not applied here — D28 post-purchase is soft |
| **L2** | 1pr→3+3 OR 3+3→5+5 | ✅ | BCBA-complement angle implicit via mechanism depth |
...
| Requirement | Status |
|-------------|--------|
| One primary CTA only | ✅ — One button CTA |
| CTA aggression: L1 Medium, L2 Low, L3 Very Low, GF Medium-Low | ✅ — Button is soft text ("Explore the bundle that fits your family"), works for all levels |
| CTA at 60-70% of body | ✅ — After mechanism, before Lena sign-off |
| Guarantee within 2 lines of CTA | ✅ — "Every additional pair is covered by the same 60-Day Guarantee..." immediately precedes CTA block |
...
| Variant | Text | Usage Rule |
|---------|------|------------|
| MEDIUM ✅ | "I have two autistic sons... With understanding, Lena" | Correct for cross-level post-purchase mid-flow. Transitions from short (education) to medium (post-purchase support). |
| Lena lives in EMAIL BODY, not a footer | ✅ — Integrated into closing paragraph | Per 11-brand-voice-reference.md §9 |

## Cross-Reference to Source Documents

| Requirement | Source Document | Section |
|-------------|----------------|---------|
| R1: Symptom over label | GIULIANO-DEMANDS.md §4 | R1 |
| R2: 3-5 recognition anchors | GIULIANO-DEMANDS.md §4 | R2 |
| R3: Age ranges | GIULIANO-DEMANDS.md §4 | R3 |
| R4: Verbal/non-verbal inclusivity | GIULIANO-DEMANDS.md §4 | R4 |
| R5: Timeline flexibility | GIULIANO-DEMANDS.md §4 | R5 |
| R6: Low-bar success metrics | GIULIANO-DEMANDS.md §4 | R6 |
| Three-Family Testimonial Pattern | MASTER-DIAGNOSIS-COMPENDIUM.md §4.6 | — |
| "Whether...Or...If..." pattern | GIULIANO-DEMANDS.md §18.1 (R3) | — |
| Cross-level copy strategy | 2-full-email-copy-strategy.md §1.12 | §1.12 |
| Flow spec: D28 timing | S02-A-framework.md §4.12 | §4.12 |
| Offer rules by level | 1-full-email-strategy.md §5.2 | §5.2 |
| Tonality framework | Layer-17-tonality-calibration.md §5 | §5 Stage 5 |
| Cross-level calibration deep ref | Layer-18-cross-level-calibration.md | Part 1-2 |
| GF sub-group constraints | Layer-21-sub-groups.md | All sections |
| CTA framework | 2-full-email-copy-strategy.md §7 | §7.1-7.3 |
| Brand voice / Lena | 11-brand-voice-reference.md §1-3, §9 | §1, §9 |
| Lena sign-off variants | 11-brand-voice-reference.md §9 | §9 |
| Forbidden phrases per level | GIULIANO-DEMANDS.md §8.5-8.6 | §8 |

## Success Criteria Verification

| Criterion | Status | Evidence |
|-----------|--------|----------|
| Output file exists at exact path | ✅ | `/root/projects/brightkidco/outputs/copy/pp-extended-upsell/ppupsell-12-e1.md` |
| File size minimum 5KB | ✅ | Significantly above threshold |
| Both halves present (Part 1 Copy + Part 2 Creative Strategy) | ✅ | Part 1: Full email copy with subject lines, preheader, body, offer table. Part 2: Full R1-R6 calibration, tonality matrix, forbidden language check, cross-references. |
| Both halves equally detailed | ✅ | Part 1: ~1,200 words. Part 2: ~1,800 words with structured tables and verification. |
| Cross-level: R1-R6 satisfied | ✅ | All 6 rules verified and documented above |
| No level-specific forbidden language | ✅ | Forbidden language check table shows zero violations |
| Three-Family Testimonial Pattern applied | ✅ | Three distinct parent voices (Sarah L1, Lisa L2, Maria L3) with level-appropriate wins |
| "Whether...Or...If..." inclusive framing | ✅ | Three instances of the pattern across hook, testimonial bridge, and offer section |
