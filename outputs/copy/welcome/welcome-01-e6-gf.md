...
| **Tone** | Gentle discovery, not accusation. No blame. The reframe lands like: "Oh, that actually makes sense." |

---

### SUBJECT LINE

**The $50/month product keeping them too dry**

*(Mechanism tease · 43 characters ✓)*
...
**1. Pull-Up vs BrightKidCo Side-by-Side Visual**

A two-column comparison placed at the mechanism reveal point:
...
*Format: Two stacked cards side-by-side on desktop, stacked vertically on mobile. Each card has a subtle icon at top (sterile shield for pull-ups, wave/signal icon for BKC).*

**2. 60-Day Guarantee Shield Badge**

A visual badge at the guarantee section:
- Icon: circular shield with checkmark (line art, 1.5px stroke, #2C2C2A warm gray)
- Text: "60-Day Guarantee · Your Judgment" in bold 14px
- Subtext: "If nothing changes, full refund" in 12px muted

**3. 3-Layer System Table**

Clean table showing each layer with:
...
| Element | Mobile | Desktop | Weight | Color | Notes |
|---------|--------|---------|--------|-------|-------|
| **Headline** | 28px | 36px | Bold (700) | `#1A1A1A` | Primary message, above-fold |
| **Subheadline** | 20px | 24px | Semi-bold (600) | `#555555` | Supporting hook |
| **Section H2** | 20px | 24px | Bold (700) | `#1A1A1A` | Section entry points |
| **Body copy** | 16px | 17px | Regular (400) | `#2C2C2A` | Main reading text |
| **Blockquote** | 16px | 16px | Italic (400) | `#555555` | Parent quotes, left indent |
| **CTA button** | 16px | 16px | Bold (700) | `#FFFFFF` | White on coral fill |
| **Stat/number** | 24px | 28px | Bold (700) | `#D85A30` | Key statistics |
| **Layer names** | 15px | 15px | Bold (700) | `#1A1A1A` | Product details |
...
- 30px padding between sections
- Letterspacing: normal for body, 0.3px for CTAs in ALL CAPS
...
**Section Dividers:**
- Thin horizontal rule: 1px solid `#D3D1C7`, 60px wide, centered
...
- 20px left padding
- Background: `#FAECE7` pale coral with 8px border-radius
- Italic body with dash attribution on its own line
...
- ✓ checkmark in coral before each trust signal (12px, aligned to text baseline)
- Body text underneath in regular weight

---

### HIDDEN DETAIL / EASTER EGG

**1. The PS Value Proposition**
...
| Element | Animation | Client Support | Fallback |
|---------|-----------|----------------|----------|
| **Hero image** | Static (PNG/JPG) | All clients | Alt text |
| **3-Layer reveal** | Optional: fade-in sequence on scroll (AMP) | Apple Mail, AMP-enabled | Static table |
| **CTA button** | Hover darken (#D85A30 → #C24A20) | Apple Mail only | No hover = no change |
| **Guarantee badge** | Static (PNG with shield icon) | All clients | Alt text |
...
| Quote | Emotion | Where It Lives in the Email |
|-------|---------|---------------------------|
...
| Science proof points from research | ✓ | Wiggins 2022 (CDC, 49%), Nicholson 2019 (interoception), Iqbal 2022 (59% signal gap) |
| CTA follows Action Verb + Benefit formula | ✓ | "Try the Body-Signal approach for 60 days. By your judgment." |
