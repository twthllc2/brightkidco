/* Welcome E8 L1 (Sarah) -- Final Offer / Soft Close
   Built from: welcome-01-e8-l1.md
   Pattern: CTA Tunnel (Pattern A), Warm Resolution palette
   Images: 5 embedded product photos
*/

/* 1. BRAND TOKENS -- Warm Resolution palette */
window.BRAND = {
  teal: "#2BAEB4",
  tealDeep: "#1E8A8F",
  green: "#5DD07A",
...
var CTAClose = function(props) {
  ...
  return React.createElement("div", { style: { background: bg, padding: "28px 22px 44px", textAlign: "center", color: "#FFF" } },
    ...
    /* Trust signals */
    props.trust ? React.createElement("div", { style: { marginTop: 20, display: "flex", flexDirection: "column", gap: 6, alignItems: "center" } },
...
var Signoff = function(props) {
  ...
  return React.createElement("div", { style: { background: props.bg || B.warmBg, padding: "24px 22px 36px" } },
    React.createElement("div", { style: { position: "relative", background: "#1F2A2C", border: "1.5px solid #2F3D40", borderRadius: 22, padding: "26px 24px 24px", overflow: "hidden" } },
      ...
      React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 14, marginBottom: 18 } },
        ...
        React.createElement("div", { style: { flex: 1, minWidth: 0 } },
          ...
          React.createElement("div", { style: { fontSize: 12, color: "#8FAFB2", marginTop: 2, fontStyle: "italic" } }, "Mom of two autistic sons")
        )
      ),
...
var OutLine = function(props) {
  return React.createElement("div", { style: { background: props.bg || B.warmBg, padding: "18px 24px 0", textAlign: "center", fontSize: 12.5, color: B.muted, fontStyle: "italic" } },
...
var Footer = function() {
  ...
  return React.createElement("div", { style: { background: B.warmBg, padding: "30px 24px 30px", textAlign: "center" } },
    ...
    f.links.map(function(l, i) {
      return React.createElement("div", { key: i, style: { fontSize: 14, color: B.warmHeading, fontWeight: 500, marginBottom: 14 } },
    ...
    React.createElement("div", { style: { fontSize: 11.5, color: B.muted, lineHeight: 1.65, margin: "0 auto", maxWidth: 340 } },
      ...
      React.createElement("span", { style: { fontSize: 10, display: "block", marginTop: 8 } }, "\u00a9 2026 BrightKidCo. All rights reserved.")
    ),
...
var EmailShell = function(props) {
  return React.createElement("div", { style: { width: MW, background: props.bg, fontFamily: F.main, color: B.warmText } },
...
var emailData = {
  ...
  productLayers: [
    { icon: "\uD83D\uDCA7", name: "Cotton inner", desc: "Gentle wetness signal that creates the 'uh-oh' moment" },
    { icon: "\uD83D\uDEE1\uFE0F", name: "Smart absorption layer", desc: "Protects furniture and floors without blocking the feedback loop" },
...
var WelcomeE8L1 = function() {
  ...
  return React.createElement(
    ...
    React.createElement("div", { style: { padding: "34px 22px 0", textAlign: "center" } },
      React.createElement("div", { style: { display: "inline-block", background: "#FFD866", padding: "7px 14px", borderRadius: 999, fontSize: 10.5, fontWeight: 700, letterSpacing: 1.5, textTransform: "uppercase", marginBottom: 16, border: "2px solid " + B.ink, transform: "rotate(-1.5deg)", whiteSpace: "nowrap", lineHeight: 1.4 } }, "Welcome \u00b7 Final"),
    ...
    React.createElement("div", { style: { background: BG_VALIDATION, padding: "28px 22px 24px" } },
    ...
    React.createElement("div", { style: { background: BG_RECAP, padding: "28px 22px 16px" } },
      ...
      React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 16 } },
        c.recapBullets.map(function(b, i) {
          return React.createElement("div", { key: i, style: { display: "flex", gap: 12, alignItems: "flex-start" } },
            ...
            React.createElement("p", { style: { fontFamily: F.main, fontSize: 14, lineHeight: 1.6, color: B.warmText, margin: 0 } },
    ...
    React.createElement("div", { style: { padding: "20px 0 0", textAlign: "center", background: BG_RECAP } },
      React.createElement("span", { style: { fontSize: 18, color: B.footerGray, opacity: 0.7, letterSpacing: 8 } }, "\u00b7 \u00b7 \u00b7")
    ),

    React.createElement(Band, { from: BG_RECAP, to: BG_SOCIAL, height: 28 }),

    /* ======= SECTION 4: SOCIAL PROOF (Quote block with left accent) ======= */
    React.createElement("div", { style: { background: BG_SOCIAL, padding: "28px 18px 8px" } },
      ...
      React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 14 } },
        c.socialQuotes.map(function(q, i) {
          return React.createElement("div", { key: i, style: { display: "flex", alignItems: "stretch" } },
            React.createElement("div", { style: { width: 4, background: accents[i], flexShrink: 0, borderRadius: 2 } }),
            React.createElement("div", { style: { background: "#FFFFFF", borderRadius: 12, padding: "18px 16px", flex: 1 } },
              React.createElement("p", { style: { fontFamily: F.main, fontSize: 14, lineHeight: 1.6, color: B.warmText, margin: "0 0 10px", fontStyle: "italic" } },
    ...
    React.createElement("div", { style: { background: BG_PRODUCT, padding: "28px 22px 16px" } },
      ...
      React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 10 } },
        c.productLayers.map(function(layer, i) {
          ...
          return React.createElement("div", { key: i, style: { display: "flex", alignItems: "center", background: "#FFFFFF", borderRadius: 12, padding: "14px 16px", borderLeft: "4px solid " + layerColors[i] } },
    ...
    /* Section divider dots */
    React.createElement("div", { style: { padding: "10px 0 0", textAlign: "center", background: BG_PHOTOS } },
      React.createElement("span", { style: { fontSize: 18, color: B.footerGray, opacity: 0.7, letterSpacing: 8 } }, "\u00b7 \u00b7 \u00b7")
    ),
    ...
    React.createElement("div", { style: { background: BG_GUARANTEE, padding: "28px 22px 24px", border: "1px solid " + B.guaranteeBorder, borderRadius: 8, margin: "0 18px" } },
    ...
    React.createElement("div", { style: { background: B.warmBg, padding: "24px 22px 0" } },
    ...
    /* ======= SECTION 10: PS ======= */
    React.createElement("div", { style: { background: B.warmBg, padding: "20px 22px 0" } },
      React.createElement("div", { style: { borderTop: "1px dashed " + B.muted, paddingTop: 18 } },
        React.createElement("p", { style: { fontFamily: F.main, fontSize: 13, lineHeight: 1.65, color: B.soft, margin: 0 } },
    ...
    React.createElement("div", { style: { padding: "0 22px", background: B.warmBg } },
      React.createElement("div", { style: { borderTop: "1px dashed " + B.muted, paddingTop: 18 } })
    ),
