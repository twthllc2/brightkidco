...
def main():
    with sync_playwright() as p:
        ...
        full_path = os.path.join(OUT, "mid-13-d30-full-420.png")
        ...
        mob_path = os.path.join(OUT, "mid-13-d30-mobile-375.png")
        ...
        abf_path = os.path.join(OUT, "mid-13-d30-above-fold-420x568.png")
        ...
        with open(os.path.join(OUT, "console-errors.txt"), "w") as f:
