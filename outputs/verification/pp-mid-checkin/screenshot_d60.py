#!/usr/bin/env python3
"""Generate 3 screenshots for mid-13-d60."""
import os
from playwright.sync_api import sync_playwright

OUT = "/root/projects/brightkidco/outputs/verification/pp-mid-checkin"
HTML = f"file://{OUT}/mid-13-d60-render.html"
...
with sync_playwright() as p:
    ...
    page1.screenshot(path=f"{OUT}/mid-13-d60-375-mobile.png", full_page=True)
    page1.close()
    ...
    page2.screenshot(path=f"{OUT}/mid-13-d60-420-full.png", full_page=True)
    page2.close()
    ...
    page3.screenshot(path=f"{OUT}/mid-13-d60-420x568-above-fold.png", full_page=False)
    page3.close()
