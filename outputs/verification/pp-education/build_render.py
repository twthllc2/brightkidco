#!/usr/bin/env python3
import os
os.chdir("/root/projects/brightkidco/outputs/verification/pp-education")

with open("/root/projects/brightkidco/raw/BKCO - EMAIL MARKETING/welcome-flow/primitives.jsx") as f:
    prims = f.read()

with open("/root/projects/brightkidco/outputs/emails/pp-education/pped-11-d7.jsx") as f:
    email = f.read()
...
root.render(React.createElement(Email_pp_education_11_d7));
</script>
</body></html>'''

with open("pped-11-d7-render.html", "w") as f:
    f.write(render)
