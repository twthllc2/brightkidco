#!/usr/bin/env python3
"""Render email HTML to screenshots using Playwright."""
import sys
from playwright.sync_api import sync_playwright

html_path = "/root/projects/brightkidco/outputs/verification/winback-b/winback-b-24-e2-l2-render.html"
...
def main():
    with sync_playwright() as p:
        ...
        page.screenshot(
            path=f"{out_dir}/winback-b-24-e2-l2-420-full.png",
            full_page=True
        )
        ...
        page.wait_for_timeout(2000)
        page.screenshot(
            path=f"{out_dir}/winback-b-24-e2-l2-375-mobile.png",
            full_page=True
        )
        ...
        page.wait_for_timeout(2000)
        page.screenshot(
            path=f"{out_dir}/winback-b-24-e2-l2-420x568-above-fold.png",
            full_page=False
        )
