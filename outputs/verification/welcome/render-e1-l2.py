#!/usr/bin/env python3
"""Render welcome-01-e1-l2 email to screenshots using Playwright."""
import os
import sys

html_path = "/root/projects/brightkidco/outputs/verification/welcome/welcome-01-e1-l2-render.html"
...
def main():
    ...
    with sync_playwright() as p:
        ...
        page.screenshot(
            path=f"{out_dir}/welcome-01-e1-l2-420-full.png",
            full_page=True
        )
        ...
        page.wait_for_timeout(3000)
        page.screenshot(
            path=f"{out_dir}/welcome-01-e1-l2-375-mobile.png",
            full_page=True
        )
        ...
        page.wait_for_timeout(3000)
        page.screenshot(
            path=f"{out_dir}/welcome-01-e1-l2-420x568-above-fold.png",
            full_page=False
        )
