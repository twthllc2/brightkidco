#!/usr/bin/env python3
"""Take 3 screenshots of welcome-01-e1-l1"""
...
with sync_playwright() as p:
    ...
    page.goto('file:///root/projects/brightkidco/outputs/verification/welcome/welcome-01-e1-l1-render.html')
    page.wait_for_timeout(4000)
    page.screenshot(
        path='/root/projects/brightkidco/outputs/verification/welcome/welcome-01-e1-l1-375-mobile.png',
        full_page=True
    )
    ...
    page.wait_for_timeout(4000)
    page.screenshot(
        path='/root/projects/brightkidco/outputs/verification/welcome/welcome-01-e1-l1-420-full.png',
        full_page=True
    )
    height = page.evaluate('document.body.scrollHeight')
    ...
    page.wait_for_timeout(4000)
    page.screenshot(
        path='/root/projects/brightkidco/outputs/verification/welcome/welcome-01-e1-l1-420x568-above-fold.png',
