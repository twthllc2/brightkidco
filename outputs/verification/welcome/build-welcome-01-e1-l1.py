#!/usr/bin/env python3
"""Build render HTML for welcome-01-e1-l1.jsx"""
import os
...
# Read email
with open("/root/projects/brightkidco/outputs/emails/welcome/welcome-01-e1-l1.jsx") as f:
    email = f.read()
...
<title>Welcome E1 L1 — Render</title>
...
root.render(React.createElement(Email_Welcome_E1_L1));
</script>
</body></html>'''

with open("welcome-01-e1-l1-render.html", "w") as f:
    f.write(render)
