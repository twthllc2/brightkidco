#!/usr/bin/env python3
"""Take 3 screenshots of welcome-01-e8-l1"""
from playwright.sync_api import sync_playwright

RENDER = '/root/projects/brightkidco/outputs/verification/welcome/welcome-01-e8-l1-render.html'
...
with sync_playwright() as p:
    ...
    page.goto(f'file://{RENDER}')
    page.wait_for_timeout(4000)
    page.screenshot(
        path=f'{OUT_DIR}/welcome-01-e8-l1-375-mobile.png',
        full_page=True
    )
    ...
    page.wait_for_timeout(4000)
    page.screenshot(
        path=f'{OUT_DIR}/welcome-01-e8-l1-420-full.png',
        full_page=True
    )
    height = page.evaluate('document.body.scrollHeight')
    ...
    page.wait_for_timeout(4000)
    page.screenshot(
        path=f'{OUT_DIR}/welcome-01-e8-l1-420x568-above-fold.png',
