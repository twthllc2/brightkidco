#!/usr/bin/env python3
"""Take 3 screenshots of welcome-01-e7-l3"""
from playwright.sync_api import sync_playwright

RENDER_HTML = '/root/projects/brightkidco/outputs/verification/welcome/welcome-01-e7-l3-render.html'
...
with sync_playwright() as p:
    ...
    page.screenshot(
        path=f'{OUT_DIR}/welcome-01-e7-l3-375-mobile.png',
        full_page=True
    )
    ...
    # Screenshot 2: 420px full (full page)
    ...
    page.wait_for_timeout(4000)
    page.screenshot(
        path=f'{OUT_DIR}/welcome-01-e7-l3-420-full.png',
        full_page=True
    )
    height = page.evaluate('document.body.scrollHeight')
    ...
    page.wait_for_timeout(4000)
    page.screenshot(
        path=f'{OUT_DIR}/welcome-01-e7-l3-420x568-above-fold.png',
