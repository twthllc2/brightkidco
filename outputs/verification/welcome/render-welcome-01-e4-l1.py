#!/usr/bin/env python3
"""Build render HTML for welcome-01-e4-l1.jsx"""
import os, re

os.chdir("/root/projects/brightkidco/outputs/verification/welcome")

def strip_line_numbers(filepath):
    with open(filepath) as f:
        return "\n".join(re.sub(r'^\d+\|', '', line) for line in f)

prims = strip_line_numbers("/root/projects/brightkidco/raw/BKCO - EMAIL MARKETING/welcome-flow/primitives.jsx")
products = strip_line_numbers("/root/projects/brightkidco/raw/BKCO - EMAIL MARKETING/welcome-flow/product-showcase.jsx")
email = strip_line_numbers("/root/projects/brightkidco/outputs/emails/welcome/welcome-01-e4-l1.jsx")
...
<title>Welcome E4 L1 — Render</title>
...
root.render(React.createElement(Email_Welcome_E4_L1));
</script>
</body></html>'''

with open("welcome-01-e4-l1-render.html", "w") as f:
    f.write(render)
