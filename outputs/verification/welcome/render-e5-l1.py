#!/usr/bin/env python3
"""Render welcome-01-e5-l1 to screenshots using Playwright."""
import os
import time
from playwright.sync_api import sync_playwright

HTML_FILE = "/root/projects/brightkidco/outputs/verification/welcome/welcome-01-e5-l1-render.html"
...
def main():
    with sync_playwright() as p:
        ...
        path1 = os.path.join(OUTPUT_DIR, "welcome-01-e5-l1-420-full.png")
        ...
        path2 = os.path.join(OUTPUT_DIR, "welcome-01-e5-l1-375-mobile.png")
        ...
        path3 = os.path.join(OUTPUT_DIR, "welcome-01-e5-l1-420x568-above-fold.png")
