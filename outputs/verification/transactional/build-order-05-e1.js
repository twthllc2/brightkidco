...
const emailRaw = fs.readFileSync('/root/projects/brightkidco/outputs/emails/transactional/order-05-e1.jsx', 'utf8');

const combinedJsx = `
var BRAND = {
  teal: '#2BAEB4', tealDeep: '#1A8A8F', green: '#5DD07A', ink: '#1F2D2F', cream: '#FBF7F1', soft: '#4A6568', muted: '#8A9B9D',
...
${emailRaw.replace(/window\.EMAILS\[.*$/ms, '')}
`;
