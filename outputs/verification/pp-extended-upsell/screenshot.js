...
(async () => {
  ...
  await page.screenshot({
    path: '/root/projects/brightkidco/outputs/verification/pp-extended-upsell/ppupsell-12-e2-full-420.png',
    fullPage: true
  });
  ...
  await page.screenshot({
    path: '/root/projects/brightkidco/outputs/verification/pp-extended-upsell/ppupsell-12-e2-mobile-375.png',
    fullPage: true
  });
  ...
  await page.waitForTimeout(500);
  await page.screenshot({
    path: '/root/projects/brightkidco/outputs/verification/pp-extended-upsell/ppupsell-12-e2-above-fold-420x568.png',
    fullPage: false
  });
