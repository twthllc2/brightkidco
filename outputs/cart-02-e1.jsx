/* Cart Abandonment E1 -- Cross-Level (cart-02-e1)
   Built from: cart-02-e1.md
   Pattern: Giuliano reference (header/footer)
   Images: 4 product photos from filesystem
*/
...
/* 4. PRODUCT IMAGES (filesystem paths) */
var IMG_HERO = "email-assets/product-photos/lifestyle/founders-holding-pants-yellow-watermelon.png";
...
var emailData = {
  ...
  heroBadge: "Your cart\u2019s still here",
  h1a: "You left something,",
  h1b: "no rush.",
  hook: "Whether you had one foot on the checkout button or you were still reading, if your child doesn\u2019t seem to feel when they need to go, you were looking in the right place. Your cart\u2019s still saved, no rush. The more useful thing in this email might be the explanation for why nothing\u2019s quite worked yet.",
  ...
  guarantee: "60 days to try it. By your judgment. If it doesn\u2019t work for your child, if you see no pause, no look, no step toward the bathroom, full refund. The guarantee isn\u2019t a sales tactic. It\u2019s the only honest thing to offer when the outcome depends on your child\u2019s nervous system.",
...
var CartE1 = function() {
  ...
  var testimonials = [
    { text: "He talked about the potty but wouldn\u2019t actually go. After two weeks in Body-Signal underwear, he paused mid-play and looked down. That pause had never happened in three years.", name: "Sarah", desc: "mom of a verbal 4-year-old" },
    { text: "My BCBA built the behavioral foundation. But nothing changed until my son\u2019s nervous system started receiving the wetness signal. That\u2019s what the underwear did, not training, just information his brain was missing.", name: "Lisa", desc: "mom of a 6-year-old with sensory differences" },
    { text: "He\u2019d never shown any awareness in 9 years. Not one sign. After 6 weeks, he pulled at his pants. That was the first signal his nervous system had ever sent him. Not trained. But feeling something for the first time, that was enough.", name: "Maria", desc: "mom of a non-verbal 8-year-old" }
  ];
  ...
  return React.createElement(EmailShell, { preheader: c.preheader, bg: BG_HERO },
    ...
    React.createElement("div", { style: { background: BG_MECHANISM, padding: "28px 22px 16px" } },
      ...
      React.createElement(H2, { size: 24 },
        "The signal ",
        React.createElement("span", { style: { background: "linear-gradient(135deg, #2BAEB4 0%, #5DD07A 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", color: "transparent", fontWeight: 700 } }, "timing"),
        " problem."
      ),
      React.createElement("p", { style: { fontSize: 15, lineHeight: 1.7, color: B.soft, margin: 0 } }, c.mechanism)
    ),
    ...
    React.createElement("div", { style: { background: BG_PRODUCT, padding: "28px 22px 16px" } },
      ...
      React.createElement(H2, { size: 24 },
        ...
        React.createElement("span", { style: { background: "linear-gradient(135deg, #2BAEB4 0%, #5DD07A 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", color: "transparent", fontWeight: 700 } }, "Layer\u2122"),
        React.createElement("br"),
        "Underwear"
      ),
    ...
    React.createElement("div", { style: { background: BG_GUARANTEE, padding: "28px 22px 32px", textAlign: "center" } },
      ...
      React.createElement(H2, { size: 26, center: true },
        "The ",
        React.createElement("span", { style: { background: "linear-gradient(135deg, #2BAEB4 0%, #5DD07A 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text", color: "transparent", fontWeight: 700 } }, "60-Day"),
        " Calm Progress Guarantee."
      ),
      React.createElement("p", { style: { fontSize: 15, lineHeight: 1.65, color: B.soft, margin: "0 0 20px", fontStyle: "italic" } }, c.guarantee),
