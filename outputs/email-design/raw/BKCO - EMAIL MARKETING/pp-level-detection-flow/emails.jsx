/* PP Level Detection · Email Components
   Each email is a React component that pulls copy from window.FLOW_PPLEVELDETECTION
   ...
   Pattern (see welcome-flow/email-6.jsx for a real example):
     const Email1 = () => {{
       const c = window.FLOW_PPLEVELDETECTION.e1;
       return (
